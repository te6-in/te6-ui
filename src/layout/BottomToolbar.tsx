...
export function BottomToolbar<T extends FieldValues>({
  ...
  return (
    <div className="pointer-events-none fixed bottom-0 left-0 z-10 w-full pb-[env(safe-area-inset-bottom)] sm:bottom-4 sm:pl-48">
      <Tag
          ...
          secondaryButtons.map((secondaryButton, index) => {
            ...
            return (
              <SecondaryButtonTag
                ...
                disabled={secondaryButton.isLoading || secondaryButton.disabled}
