...
export function TabBarItem({ icon: Icon, text, href }: TabBarItemProps) {
  ...
  return (
    <Link
      className={j(
        "flex flex-col items-center justify-center gap-1 rounded-xl ring-inset transition-all focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 focus-visible:ring-offset-body active:scale-95 dark:focus-visible:ring-offset-body-dark sm:flex-row sm:justify-start sm:gap-2 sm:p-4 sm:hover:bg-base-200 dark:sm:hover:bg-base-dark-900",
